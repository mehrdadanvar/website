<template>
  ...
  >
    ...
    <div class="text-gray-500 text-sm lg:text-2xl">
      <h4>Physician, Health Researcher</h4>
      <h4>Full Stack Web Developer</h4>
    </div>

    <p class="text-md lg:text-xl text-gray-500">
...
<script setup>
let side_props = defineProps({
  name: String,
  title: String,
});
console.log(side_props);
let socials = [
  { id: 0, icon_name: "i-simple-icons-linkedin", link: "https://www.linkedin.com/in/mehrdad-anvar/" },
  { id: 1, icon_name: "i-simple-icons-github", link: "https://github.com/mehrdadanvar" },
  { id: 2, icon_name: "i-simple-icons-gmail", link: "mailto:mehrdad.anvar@gamil.com" },
  { id: 3, icon_name: "i-simple-icons-gitlab", link: "" },
  { id: 4, icon_name: "i-carbon-phone", link: "tel:+12368665644" },
];
</script>
